...
// encompassing widget.
const EdgeInsetsGeometry _kHorizontalItemPadding = EdgeInsets.symmetric(vertical: 4, horizontal: 4);
...
const double _kMinSegmentedControlHeight = 26.0;
...
// closest child.
const double _kSegmentMinPadding = 12.25;
...
const double _kCornerRadius = 50.0;
...
class CupertinoSlidingSegmentedControlAlt<T> extends StatefulWidget {
  ...
  /// in the [children] map.
  CupertinoSlidingSegmentedControlAlt({
    Key? key,
  ...
  @override
  State<CupertinoSlidingSegmentedControlAlt<T>> createState() => _SegmentedControlState<T>();
}

class _SegmentedControlState<T> extends State<CupertinoSlidingSegmentedControlAlt<T>>
    with TickerProviderStateMixin<CupertinoSlidingSegmentedControlAlt<T>> {
  ...
  @override
  void didUpdateWidget(CupertinoSlidingSegmentedControlAlt<T> oldWidget) {
    super.didUpdateWidget(oldWidget);
