...
class RewardsWalletContainer extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Consumer<RewardsController>(builder: (context, controller, child) {
      return Container(
        ...
        child: Column(
          ...
          children: [
            ...
            Row(
              ...
              children: [
                controller.earningVisible
                    ? RichText(
                        text: TextSpan(
                            text: formatCurrency(num.parse(
                                    controller.referralInfo?.totalEarnings ??
                                        '0'))
                                .split('.')
                                .first,
                            ...
                            TextSpan(
                                text:
                                    '.${formatCurrency(num.parse(controller.referralInfo?.totalEarnings ?? '0')).split('.').last}',
                ...
                GestureDetector(
                  onTap: () {
                    controller.onToggleEarningVisibility();
                  },
                  child: Icon(
                    controller.earningVisible
                        ? Icons.visibility
