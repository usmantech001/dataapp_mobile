...
import 'create_card/arg/fund_card_request.dart';

class UnblockVirtualCardView extends StatelessWidget {
  final String id;
  const UnblockVirtualCardView({super.key, required this.id});
    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          const Text(
            'Are you sure you want to unfreeze this virtual card?',
            style: TextStyle(
