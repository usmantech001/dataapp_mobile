...
class FundUsdCard extends StatefulWidget {
  final String id;
  const FundUsdCard({super.key, required this.id});

  @override
  State<FundUsdCard> createState() => _FundUsdCardState();
}

class _FundUsdCardState extends State<FundUsdCard> {
