...
class InternationalData2 extends StatelessWidget {
  final InternationalDataArg arg;

  const InternationalData2({super.key, required this.arg});
          ...
          CustomButton(
            ...
            onTap: () async {
              createTransaction(BuildContext context,
                ...
                try {
                  ServiceTxn _ = await ServicesHelper.buyInternationalData(
                    code:arg.providerType.code,
                    pin: transaction_pin,
