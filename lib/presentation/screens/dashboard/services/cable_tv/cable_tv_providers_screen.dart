    ...
    return Scaffold(
      ...
      body: Column(
        children: [
          ...
          Expanded(child: cableTvController.gettingProviders? Center(child: CircularProgressIndicator()): ListView.separated(
            padding: EdgeInsets.symmetric(horizontal: 15, vertical: 20),
            itemBuilder: (context, index){
              final provider = cableTvController.tvServiceProviders[index];
            return InkWell(
              onTap: (){
                ...
                // }
                  Navigator.pushNamed(context, RoutesManager.cableTvPackages);
          ...
          }, separatorBuilder: (context, index)=> Gap(8), itemCount: cableTvController.tvServiceProviders.length))
        ],
      ),
    );
  }
