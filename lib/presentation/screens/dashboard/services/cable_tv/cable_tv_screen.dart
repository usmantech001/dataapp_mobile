        ...
        bottomNavigationBar: CustomBottomNavBotton(
            ...
            onTap: () {
             ...
             generalController.getDiscount(type: 'tv', provider: cableController.selectedProvider!.code, code: cableController.selectedPlan!.code.toString(), onSuccess: (discount) {
              ...
              final summaryItems = [
                SummaryItem(
                    title: 'TV/Cables Provider',
                    name: cableController.selectedProvider?.name ?? ""),
                SummaryItem(
                  title: 'Package Type',
                  name:
                      "${cableController.cableTvTypes[cableController.currentTabIndex]} Package",
                ),
                SummaryItem(
                  title: 'Duration',
                  name: "${cableController.selectedPlan!.duration} Month",
                  hasDivider: true,
                ),
                SummaryItem(
              ...
              final reviewModel = ReviewModel(
                  ...
                  onPinCompleted: (pin) async {
                    ...
                    cableController.purchaseCableTv(
                      pin,
              ...
              children: [
                ...
                CustomInputField(
                  ...
                  textEditingController:
                      cableController.decoderNumberController,
                ),
